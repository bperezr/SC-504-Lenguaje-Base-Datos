            ...
            <div class="contenedor-campos">
                ...
                <div class="campo">
                    ...
                    <input type="date" id="fecha" name="fecha" min="<?php echo date('Y-m-d'); ?>"
                        onchange="obtenerHorariosDisponibles()">
                </div>
                    ...
                    <select id="horario" name="horario">
                       ...
                       */
                        ...
                        foreach ($horarios as $horario) {
                            ...
                            foreach ($camposDisponibles as $citasdisponibles) {
                                if ($horario['idHorario'] == $citasdisponibles['idHorario'] && $fechaSeleccionada == $citasdisponibles['fecha']) {
                        ...
                        foreach ($horariosDisponibles as $horarioDisponible) {
                            echo '<option value="' . $horarioDisponible['horaInicio'] . '">' . $horarioDisponible['horaInicio'] . '</option>';
                        }
