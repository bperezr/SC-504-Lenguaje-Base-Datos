CREATE DATABASE IF NOT EXISTS `happypaws`
...
(
    ...
    'Araya',
    '60245117',
    'f044667adf711a3ec27fb6d1da4fe8cf.jpg',
    '200 metros sur del hotel Villas de la Colina',
    1,
    101,
    10101,
    3,
    'jorge@email.com',
    '$2y$10$EeR5YV6qbqeCwr6KyhPhs.9OE7iJU8AJSwWlx1PYmJWjxCibIZm5O'
  );
...
(
    ...
    1,
    5,
    '43a172d08c82cba40c8cc7669a553c00.jpg',
    1,
    'admin@happypaws.com',
    '$2y$10$mUzXRxlpxft5KeGBsOfSz.E4.n2iCzRouxlf5gxwQe75Y/6pOqM4S'
  ),
  (
    2,
    'Luis Carlos',
    ...
    3,
    1,
    '4512cd38ce4ed7fbf944f817a9e28b68.jpg',
    2,
    'juan.moreles@happypaws.com',
    '$2y$10$TuO6Dyr3qF0tQtH0J0r/he6l40.wUOiea7bWXkK8cESCcPotlS7AS'
  ),
(
    3,
    'Ana',
    ...
    3,
    2,
    '814bf8304eb6011bbf97fd94350b44fe.jpg',
    2,
    'ana.rodriges@happypaws.com',
    '$2y$10$AiN6qE07lOjAOYWfrF.us.y19Rl72k7i3ekA9K5rz/s2LrGzJzKjS'
  ),
(
    4,
    'Elizabeth',
    ...
    1,
    4,
    '296728b02f2db0822d8658b214172f01.jpg',
    2,
    'elizabeth.gomez@happypaws.com',
    '$2y$10$YK0opKbIEHSVEfKZ8FVCS.i3NzKVejkm27yATzyCiZ20FWOq25gd2'
  ),
(
    5,
    'Sofia',
    ...
    3,
    3,
    'fee34ecf2b12c6259162670efd678cd9.jpg',
    2,
    'sofia.rojas@happypaws.com',
    '$2y$10$Nm70ne8cNIbaOpkCx19Eju/8e.dxqQazxbRWH1JJMgzAoLSPOoQ1W'
  );
...
VALUES
  (
    1,
    'Medicina General',
    'Atención y cuidado general de la salud de los animales, incluyendo diagnóstico y tratamiento de enfermedades comunes.'
  ),
(
    2,
    'Cirugía',
    'Realización de procedimientos quirúrgicos en animales para tratar diversas condiciones médicas.'
  ),
(
    3,
    'Castración',
    'Procedimiento quirúrgico para esterilizar animales, evitando su reproducción y controlando la población.'
  ),
(
    4,
    'Aseo',
    'Servicios de limpieza y cuidado de higiene para mantener a los animales limpios y saludables.'
  ),
(
    5,
    'Administrador',
...
VALUES
  (
    ...
    'f980d313262c9e939186bcecdeb8a083.jpg',
    1,
    101,
    10101,
    'Campaña de Castración Felina y Canina'
...
(
    ...
    '10:00:00',
    '14:00:00',
    'Día de Adopción Responsable',
    'fca9f567b40e6266fee2be3a288cd70b.jpg',
    1,
    101,
    10101,
    'Día de Adopción Responsable'
...
(
    ...
    '08:30:00',
    '16:30:00',
    'Charla sobre Nutrición y Salud Animal',
    'cc3e82020d07451ccbe59f4cc57ef565.jpg',
    1,
    101,
    10101,
    'Charla sobre Nutrición y Salud Animal'
...
(
    ...
    '11:00:00',
    '04:00:00',
    'Exposición de Razas Caninas',
    '453952d44dc3c0a018eae36a22f78833.jpg',
    1,
    101,
    10101,
    'Exposición de Razas Caninas'
...
(
    ...
    '13:00:00',
    'Vacunación Gratuita',
    '4fdf54a7f4d79fd5d03abe16bc9a1011.jpg',
    1,
    101,
    10101,
    'Vacunación Gratuita'
...
(
    ...
    'aa3a47b08ab10594c53e4f2914f92a45.jpg',
    1,
    101,
    10101,
    'Taller de Adiestramiento Canino'
...
VALUES
  (
    1,
    'Buddy',
    'Es un doberman de 80kg, pelo negro y muy amigable',
    NULL,
    1,
    18
  ),
(
    2,
    'Max',
    'Es un gato muy especial, pero un poco arizco',
    NULL,
    1,
    18
  ),
(
    3,
    'Luna',
    'Es mi mejor amiga, tiene 2 anios',
    NULL,
    2,
    18
  );
...
(
    2,
    'Cirugía',
    'Procedimientos quirúrgicos para mascotas.'
  ),
(
    3,
    'Castración',
    'Servicios de castración para mascotas.'
  ),
(
    4,
    'Aseo de Mascotas',
    'Servicios profesionales de aseo para mascotas.'
  );
